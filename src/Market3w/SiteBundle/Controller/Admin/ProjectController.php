...
namespace Market3w\SiteBundle\Controller\Admin;
...
use Market3w\SiteBundle\Form\Type\Admin\ProjectType;
...
class ProjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Market3wSiteBundle:Project')->findAll();
     ...
     * @Method("POST")
     * @Template("Market3wSiteBundle:Project:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('Market3wSiteBundle:Project')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("Market3wSiteBundle:Project:edit.html.twig")
     */
